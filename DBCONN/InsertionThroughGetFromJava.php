<?php
 ...
 if(isset($_GET["f_name"]) && isset($_GET["f_name"]))    //isset function checks if a variable is declared or not, returns true or false
 {
	$firstname= trim($_GET["f_name"]);		//take care of the parameters
	$lastname= trim($_GET["l_name"]);		//parameter name must be same which is sent by AddGetRequest.java
