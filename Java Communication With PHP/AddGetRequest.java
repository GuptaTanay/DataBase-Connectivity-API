...
public class AddGetRequest {
    ...
    public static void main(String[] args) {
        ...
        String url_string = "http://localhost/androidcheck/DBCONN/InsertionThroughGetFromJava.php";        //save your php file in htdocs of xampp, then only it can be accessed by localhost url
        url_string += "?f_name=" + URLEncoder.encode(first_name);			//take care to match the f_name with $_GET["f_name"]
        url_string += "&l_name=" + URLEncoder.encode(last_name); 			//take care to match the l_name with $_GET["l_name"]
        ...
        try {
            ...
            con.setRequestMethod("GET");					//sets the method by which we want to send the request .ie. GET,POST,REQUEST
